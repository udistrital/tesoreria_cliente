...
@Component({
  selector: 'ngx-descargarcomprobante',
  templateUrl: './descargarcomprobante.component.html',
  styleUrls: ['./descargarcomprobante.component.scss']
})
export class DescargarcomprobanteComponent implements OnInit {

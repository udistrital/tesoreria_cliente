...
import { DATOS_CONTABILIZACION_2 } from '../../../consulta-matriculas/interfaces/interfaces';
import { DATOS_CONTABILIZACION_3 } from '../../interfaces/interfaces';
...
export class ContabilizacionComponent implements OnInit {
  ...
  constructor() {
    this.datos = DATOS_CONTABILIZACION_3;

...
@Component({
  selector: 'ngx-set-descargarcomprobante',
  templateUrl: './set-descargarcomprobante.component.html',
  styleUrls: ['./set-descargarcomprobante.component.scss']
})
export class SetDescargarcomprobanteComponent implements OnInit {
  ...
  pdfSrc = '../../../../../assets/images/crp-ejemplo.pdf'; // this sample, dynamic one we will generate with the pdfmake
  pageVariable = 1;

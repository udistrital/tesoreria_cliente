...
@Component({
  selector: 'ngx-form-seguimiento-proyeccion',
  templateUrl: './form-seguimiento-proyeccion.component.html',
  styleUrls: ['./form-seguimiento-proyeccion.component.scss']
})
export class FormSeguimientoProyeccionComponent implements OnInit {
